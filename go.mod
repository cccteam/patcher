...
require (
	...
	github.com/cccteam/ccc/patchset v0.3.2
	github.com/cccteam/httpio v0.7.3
	github.com/cccteam/session v0.4.1
...
require (
	...
	github.com/cccteam/ccc/resourceset v0.4.1 // indirect
